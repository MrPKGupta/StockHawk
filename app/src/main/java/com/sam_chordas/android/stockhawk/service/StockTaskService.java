...
public class StockTaskService extends GcmTaskService {
    ...
    public int onRunTask(TaskParams params) {
        ...
        if (params.getTag().equals(mContext.getResources().getString(R.string.string_init))
                || params.getTag().equals(mContext.getResources().getString(R.string.string_periodic))) {
            isUpdate = true;
